  ...
  return (
    <>
      <div className="my-5">
        ...
        ></textarea>
        <button className="btn btn-info my-3 mx-1" onClick={changetoUpper}>
          Convert to UpperCase
        </button>
        <button className="btn btn-info my-3 mx-1" onClick={changetoLower}>
        ...
        <button className="btn btn-info my-3 mx-1" onClick={changetoUnicode}>
          Convert to Unicode
        </button>
        <button className="btn btn-info my-3 mx-1" onClick={changetoText}>
          Convert Unicode to Text
        </button>
        <button className="btn btn-info my-3 mx-1" onClick={clearAll}>
          Clear All
        </button>
        ...
        <div className="container preview"><h2>Preview</h2>{text}</div>
